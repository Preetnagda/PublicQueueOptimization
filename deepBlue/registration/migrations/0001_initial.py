...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_time', models.DateTimeField(default=datetime.datetime(2019, 12, 19, 22, 20, 11, 814137))),
                ...
                ('consultation_time_in', models.DateTimeField(default=datetime.datetime(2019, 12, 19, 22, 20, 11, 814137))),
